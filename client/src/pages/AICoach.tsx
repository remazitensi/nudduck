    ...
    <div className='chatRoom flex flex-col items-center'>
      ...
      <div className='mt-[30px] mb-[50px] flex w-[1130px] justify-center'>
        <div className='flex gap-[30px]'>
          <div className='Left-list h-[900px] w-[300px] rounded-[30px] border border-[#8D8B67] bg-[#FBFAEC]'>
            ...
            <div className='h-[calc(100%_-_100px)] p-[15px]'>
              <div className='h-full w-full'>
                <ul className='flex h-[750px] flex-col gap-[10px] overflow-y-auto p-[10px]'>
          ...
          <div className='ID-container h-[900px] w-[800px] rounded-[30px] border border-[#8D8B67]'>
            ...
            <div ref={chatContainerRef} className='Display-container flex h-[740px] w-full border-b-[1px] border-[#59573D] bg-white overflow-y-auto'>
