      ...
      <div className='flex h-[870px] w-[700px] flex-col rounded-[20px] bg-white shadow-lg' onClick={(e) => e.stopPropagation()}>
        ...
        <div className='mt-[65px]'>
          <div className='ml-[60px] flex flex-col'>
            ...
            <div className='mt-[30px] text-[18px]'>그래프 제작에 필요한 그래프 제목과 현재 나이를 입력합니다.</div>
            <div>
              <div className='mt-[25px] text-[18px]'>제목</div>
              <div>
          ...
          <div className='mt-[50px] flex justify-center'>
            <button
              onClick={onClose}
              className='flex h-[50px] w-[220px] items-center justify-center rounded-xl border border-[#909700] bg-white text-[24px] font-bold text-[#909700] hover:bg-[#909700] hover:text-white'
            >
              나가기
            </button>
          </div>
