/**
 * File Name    : category.service.spec.ts
 * Description  : 커뮤니티 서비스 카테고리 관련 기능의 유닛 테스트
 * Author       : 김재영
 *
 * History
 * Date          Author      Status      Description
 * 2024.09.13    김재영      Created     카테고리 기능에 대한 테스트 케이스 작성
 */
...
import { Category } from '../src/modules/community/enums/category.enum';
